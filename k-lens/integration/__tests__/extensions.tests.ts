...
describe("extensions page tests", () => {
  ...
  const extensions = process.env.EXTENSION_PATH
    ...
    : [
        "@k-lens/example-extension",
        "@k-lens/example-extension@1.3.0",
        "@k-lens/extension-example@1.2.0",
        "@k-lens/extension-example@1.0.0",
        "@k-lens/k-lens-node-pod-menu",
        "@k-lens/k-lens-node-pod-menu@1.1.0",
        "@k-lens/k-lens-node-pod-menu@1.0.0",
      ];
